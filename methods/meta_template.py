...
class MetaTemplate(nn.Module):
    ...
    def parse_feature(self, x, is_feature):
        # ZSL: seperate support and query
        ...
        z_support = z_all[:, :self.n_support] # ZSL: Shape: (self.n_way, self.n_support + self.n_query, d) 
        z_query = z_all[:, self.n_support:]

        return z_support, z_query
# ZSL: correct and correlation are some computation functions
    def correct(self, x):
